...
5. Create a Node/Express/MongoDB/ReactJS app called `nytreact`. This will be a recreation of the [NYT Articles Search](http://nytarticle-search.herokuapp.com/) exercise application we built back in [Week 6](../../../Class-Content/06-Week/Activities/16-NYTSearch/Solution/NYTArticleSearch_Best_Solution/nyt-example.html). Running this application will:
